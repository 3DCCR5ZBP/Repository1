...
The purpose of this data project is to build a model usinf this datas to predict if a teenager is in danger of developing depression. There is an increase in serve 
...
From analysing the data above we can see that while there are some anacronisms between the data the split amongst the groups as is close to even as can realistically be expected, this gives confidence in using the data to build an exact model.
